...
import com.xingyun.linkiebuy.common.mybatis.wrapper.MapWrapperFactory;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.xingyun.linkiebuy.*.mapper", sqlSessionFactoryRef = "sqlSessionFactory")
